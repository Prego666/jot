<template>
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 borer-gray-400">
                <nav class="pt-4">
                    <router-link to="/">
                        <svg class="fill-current text-blue-600 w-12 h-12" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24">
                            <path
                    ...
                    <p class="pt-12 text-gray-500 text-sm uppercase font-bold">Create</p>
                    ...
                    <p class="pt-12 text-gray-500 text-sm uppercase font-bold">General</p>
                    ...
                    <p class="pt-12 text-gray-500 text-sm uppercase font-bold">Settings</p>
