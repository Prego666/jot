    ...
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    <label for="name" class="uppercase text-blue-500 text-sm font-bold absolute pl-3 pt-3"
                    >Full name</label>
                ...
                <div class="relative pt-3">
                    <label for="email" class="uppercase text-blue-500 text-sm font-bold absolute pl-3 pt-3"
                    >E-mail</label>
                ...
                <div class="relative pt-3">
                    <label for="password"
                           class="uppercase text-blue-500 text-sm font-bold absolute pl-3 pt-3">Password</label>
                ...
                <div class="relative pt-3">
                    <label for="password-confirm"
                           class="uppercase text-blue-500 text-sm font-bold absolute pl-3 pt-3">Re-enter Password</label>
                ...
                <div class="pt-8">
                    <button type="submit"
                            class="w-full bg-gray-400 uppercase rounded text-blue-800 text-left font-bold py-2 px-3">
                        Register
                    </button>
                </div>

                <div class="flex justify-between pt-3 text-white text-sm font-bold">
